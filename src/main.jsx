...
function Shell({children,onBack,title,step}){
 return <div className="screen-shell">
   <header className="topbar"><div className="brand"><div className="logo"><HeartPulse size={23}/></div><div><b>ClinSutra</b><span>Smart Case Taking for Better Care</span></div></div><div className="step">{step}</div></header>
